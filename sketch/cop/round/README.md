...
|-- ROUND  /self -1  /at -1  /per -1  /from -1.49  /to -0.51  /ns [ -1.49 | -1.25 | -1.01 | -1.00 | -0.99 | -0.75 |
    -0.51 ]
|-- ROUND  /self 0  /at 0  /per 0  /from -0.50  /to 0.50  /ns [ -0.50 | -0.49 | -0.25 | -0.01 | 0.00 | 0.01 | 0.25 |
    0.49 | 0.50 ]
|-- ROUND  /self 1  /at 1  /per 1  /from 0.51  /to 1.49  /ns [ 0.51 | 0.75 | 0.99 | 1.00 | 1.01 | 1.25 | 1.49 ]
|-- ROUND  /self 2  /at 2  /per 2  /from 1.50  /to 2.50  /ns [ 1.50 | 1.51 | 1.75 | 1.99 | 2.00 | 2.01 | 2.25 | 2.49 |
    2.50 ]

|-- ROUND  /self 3  /at 3  /per 3  /from 2.51  /to 3.49  /ns [ 2.51 | 2.75 | 2.99 | 3.00 | 3.01 | 3.25 | 3.49 ]
|-- ROUND  /self 4  /at 4  /per 4  /from 3.50  /to 4.50  /ns [ 3.50 | 3.51 | 3.75 | 3.99 | 4.00 | 4.01 | 4.25 | 4.49 |
    4.50 ]
...
|-- ROUND  /self -2  /at -2  /per -2  /from -2.00  /to -1.50  /ns [ -2.00 | -1.99 | -1.75 | -1.51 | -1.50 ]
|-- ROUND  /self -1  /at -1  /per -1  /from -1.49  /to -0.50  /ns [ -1.49 | -1.25 | -1.01 | -1.00 | -0.99 | -0.75 |
    -0.51 | -0.50 ]
...
|-- ROUND  /round 1.34  /from 1.20  /to 1.45  /ns [ 1.20 | 1.25 | 1.30 | 1.35 | 1.40 | 1.45 ]
|-- ROUND  /round 1.67  /from 1.50  /to 1.80  /ns [ 1.50 | 1.55 | 1.60 | 1.65 | 1.70 | 1.75 | 1.80 ]
|-- ROUND  /round 2.00  /from 1.85  /to 2.15  /ns [ 1.85 | 1.90 | 1.95 | 2.00 | 2.05 | 2.10 | 2.15 ]
|-- ROUND  /round 2.34  /from 2.20  /to 2.45  /ns [ 2.20 | 2.25 | 2.30 | 2.35 | 2.40 | 2.45 ]

|-- ROUND  /round 2.67  /from 2.50  /to 2.80  /ns [ 2.50 | 2.55 | 2.60 | 2.65 | 2.70 | 2.75 | 2.80 ]
|-- ROUND  /round 3.00  /from 2.85  /to 3.15  /ns [ 2.85 | 2.90 | 2.95 | 3.00 | 3.05 | 3.10 | 3.15 ]
|-- ROUND  /round 3.34  /from 3.20  /to 3.45  /ns [ 3.20 | 3.25 | 3.30 | 3.35 | 3.40 | 3.45 ]
|-- ROUND  /round 3.67  /from 3.50  /to 3.80  /ns [ 3.50 | 3.55 | 3.60 | 3.65 | 3.70 | 3.75 | 3.80 ]
...
TABLE : ROUND
  ...
  1.34   1.20   1.45   [ 1.20 | 1.25 | 1.30 | 1.35 | 1.40 | 1.45 ]
  1.67   1.50   1.80   [ 1.50 | 1.55 | 1.60 | 1.65 | 1.70 | 1.75 | 1.80 ]
  2.00   1.85   2.15   [ 1.85 | 1.90 | 1.95 | 2.00 | 2.05 | 2.10 | 2.15 ]
  2.34   2.20   2.45   [ 2.20 | 2.25 | 2.30 | 2.35 | 2.40 | 2.45 ]
  2.67   2.50   2.80   [ 2.50 | 2.55 | 2.60 | 2.65 | 2.70 | 2.75 | 2.80 ]
  3.00   2.85   3.15   [ 2.85 | 2.90 | 2.95 | 3.00 | 3.05 | 3.10 | 3.15 ]
  3.34   3.20   3.45   [ 3.20 | 3.25 | 3.30 | 3.35 | 3.40 | 3.45 ]
  3.67   3.50   3.80   [ 3.50 | 3.55 | 3.60 | 3.65 | 3.70 | 3.75 | 3.80 ]
